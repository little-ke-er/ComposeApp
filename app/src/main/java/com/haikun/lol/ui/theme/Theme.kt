package com.haikun.lol.ui.theme
...
fun LolAppTheme(
    ...
    val color = when (lolTheme.pallet) {
        GREEN -> green700
        BLUE -> blue700
        ORANGE -> orange700
        PURPLE -> purple700
    }
    systemUiController?.setStatusBarColor(color = color, darkIcons = lolTheme.darkTheme)

    val colors = when (lolTheme.pallet) {
